...
public class CaesarDecryptClass extends crypto.basicCrypt {

	// Im Konstruktor das Aussehen definieren
	public CaesarDecryptClass() {
		className = "Cäsar Chiffre Entschlüsseln";
	...
	public void calculate() {
		...
		outputLogText += decode(k, alphabet) + "\r\n"; 
